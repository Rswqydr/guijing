...
public class GuijingGoods {
    ...
    public GuijingGoods(Long goodsId, String goodsName, String goodsInfo, Long goodsCategoryId, String goodsCoverImg, String goodsCarousel, String goodsDetailContent, Integer originalPrice, Integer sellingPrice, Integer stockNum, String tag, Byte goodsSellStatus, Integer createUser, Date createTime, Integer updateUser, Date updateTime) {
        this.goodsId = goodsId;
        this.goodsName = goodsName;
        this.goodsIntro = goodsInfo;
    ...
    public void setgoodsIntro(String goodsInfo) {
        this.goodsIntro = goodsInfo;
    }
